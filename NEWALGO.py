...
def main():
    ...
    def mini_max(node, depth, maxPlayer, board, piece):
        ...
        if maxPlayer:
            ...
            for col in columns:
                ...
                value = max(maximum, mini_max(next, depth - 1, False, temp_board, piece))
                if value > maximum:
                    maximum = value
                    bestCol = col
                node.value = value
            ...
            for col in columns:
                ...
                value = min(minimum, mini_max(next, depth - 1, True, temp_board, piece))
                if value < minimum:
                    minimum = value
                    bestCol = col
                node.value = value
    ...
    while not game_over:
        ...
        if turn == 1:
            ...
            mini_max(root, start_depth, True, board, piece)
